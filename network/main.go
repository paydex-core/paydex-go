// Package network contains functions that deal with paydex network passphrases
// and IDs.
package network
...
import (
	...
	"github.com/paydex-core/paydex-go/hash"
	"github.com/paydex-core/paydex-go/support/errors"
	"github.com/paydex-core/paydex-go/xdr"
)

const (
	// PublicNetworkPassphrase is the pass phrase used for every transaction intended for the public paydex network
	PublicNetworkPassphrase = "Public Global Paydex Network ; September 2015"
...
// resulting hash is the value that can be signed by paydex secret key to
// authorize the transaction identified by the hash to paydex validators.
