...
// structures used by the paydex network, most importantly transactions.
//
...
// maintained. It will be removed in future versions of the SDK. Use txnbuild (https://godoc.org/github.com/paydex-core/paydex-go/go/txnbuild) instead.
package build
...
var (
	...
	// to the main public paydex network.
...
// Network establishes the paydex network that a transaction should apply to.
