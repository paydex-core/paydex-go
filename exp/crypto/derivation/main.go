...
const (
	// PaydexAccountPrefix is a prefix for Paydex key pairs derivation.
	PaydexAccountPrefix = "m/44'/148'"
	// PaydexPrimaryAccountPath is a derivation path of the primary account.
	PaydexPrimaryAccountPath = "m/44'/148'/0'"
	// PaydexAccountPathFormat is a path format used for Paydex key pair
	// derivation as described in SEP-00XX. Use with `fmt.Sprintf` and `DeriveForPath`.
	PaydexAccountPathFormat = "m/44'/148'/%d'"
