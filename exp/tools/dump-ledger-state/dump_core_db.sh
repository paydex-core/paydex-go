# Get state from paydex-core DB, colums match CSV printer
...
echo "Fetching accounts from paydex-core DB..."
...
echo "Fetching accountdata from paydex-core DB..."
...
echo "Fetching offers from paydex-core DB..."
...
echo "Fetching trustlines from paydex-core DB..."
