...
// ledgerHeaderHistory is a helper struct used to unmarshall header fields from a paydex-core DB.
type ledgerHeaderHistory struct {
	Hash   xdr.Hash         `db:"ledgerhash"`
	Header xdr.LedgerHeader `db:"data"`
}

// ledgerHeader holds a row of data from the paydex-core `ledgerheaders` table.
...
// txHistory holds a row of data from the paydex-core `txhistory` table.
...
// txFeeHistory holds a row of data from the paydex-core `txfeehistory` table.
...
// scpHistory holds a row of data from the paydex-core `scphistory` table.
...
// upgradeHistory holds a row of data from the paydex-core `upgradehistory` table.
