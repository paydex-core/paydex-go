...
import (
	...
	"github.com/paydex-core/paydex-go/services/bridge/internal/mocks"
	"github.com/paydex-core/paydex-go/services/bridge/internal/test"
...
func TestRequestHandlerBuilder(t *testing.T) {
	...
	mockPaydextomlResolver := new(mocks.MockPaydextomlResolver)
	...
	requestHandler := RequestHandler{
		...
		PaydexTomlResolver:  mockPaydextomlResolver,
	}
	...
	// https://www.paydex.org/laboratory/#xdr-viewer?input=AAAAAGySS3ZylffFaVZqZD6lNCUjCizHz7MLPwkN7Mxh4XN5AAAAZAAAAAAAAAB8AAAAAQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAQAAAAAAAAAAAAAAAJxDO5t5ZLJxX7RzBsXbeh04rVEEn71b45PCX3blnyvnAAAAAB3NZQAAAAAAAAAAAZ%2BNtPwAAABAXJ4I9DwPZKt7yO0j8IsIsc6VLUJz%2FyZ3LK%2F%2F%2Bxpxf6Mbbl%2B7cFq7wG776h7VLmDTBrSEQOydKuR0Yup4gFqYAQ%3D%3D&type=TransactionEnvelope&network=test
	...
	responseString = strings.TrimSpace(string(response))
	assert.Equal(t, 200, statusCode)
	// https://www.paydex.org/laboratory/#xdr-viewer?input=AAAAAGySS3ZylffFaVZqZD6lNCUjCizHz7MLPwkN7Mxh4XN5AAAAZAAAAAAAAAB7AAAAAQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAQAAAAAAAAAAAAAAAJxDO5t5ZLJxX7RzBsXbeh04rVEEn71b45PCX3blnyvnAAAAAB3NZQAAAAAAAAAAAZ%2BNtPwAAABAN836LQKoUHzAKLTkizVKb9PsFdf73eNOSRKKGd%2BzAB9GrnlsKDLbegtt9eqvYjQ4AHzbeqJBIGX%2FHQFXCadAAw%3D%3D&type=TransactionEnvelope&network=test
	expected = test.StringToJSONMap(`{
	...
	// https://www.paydex.org/laboratory/#xdr-viewer?input=AAAAAGySS3ZylffFaVZqZD6lNCUjCizHz7MLPwkN7Mxh4XN5AAAAZAAAAAAAAAB7AAAAAQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAQAAAAAAAAABAAAAAJxDO5t5ZLJxX7RzBsXbeh04rVEEn71b45PCX3blnyvnAAAAAVVTRAAAAAAABEm552OXLKzdRDY%2FKgNQgAxTE5wOgmPINknKuCMesY8AAAAAO5rKAAAAAAAAAAABn420%2FAAAAEBckKXSMZ9M2sZqbv53XTGw0Mv91MntHbQpn%2FV0TtoVGHBWMLIJ8ePG7E0%2B7Dc06g%2BAUR%2FoTWaoI6WWCe5SKMAL&type=TransactionEnvelope&network=test
	expected = test.StringToJSONMap(`{
  ...
  "operations": [
	...
	// https://www.paydex.org/laboratory/#xdr-viewer?input=AAAAAGySS3ZylffFaVZqZD6lNCUjCizHz7MLPwkN7Mxh4XN5AAAAZAAAAAAAAAB7AAAAAQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAQAAAAAAAAAGAAAAAVVTRAAAAAAAjmjVs7grt12sFIHthoIfgZzfz267zUA%2BMis7mPD3by1%2F%2F%2F%2F%2F%2F%2F%2F%2F%2FwAAAAAAAAABn420%2FAAAAEAr4jYveod1stUGiW9Uy99mDz5gjCJp%2FNPTu3P0uVRLEGOAcM9GyEMCvm2VnK4HAtSZiCxrCmcZGTqSd38zUBgC&type=TransactionEnvelope&network=test
	expected = test.StringToJSONMap(`{
	...
	//https://www.paydex.org/laboratory/#xdr-viewer?input=AAAAAGySS3ZylffFaVZqZD6lNCUjCizHz7MLPwkN7Mxh4XN5AAAAZAAAAAAAAAB7AAAAAQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAQAAAAAAAAAJAAAAAAAAAAGfjbT8AAAAQDukGibnqm%2B%2FGQyn0xZH4a%2FyZlUNAolyrhXzsmVeCmxs3ss24RwEST2lSqrwBLnTYbpLrHPlFT2Ye14apwJ8gA4%3D&type=TransactionEnvelope&network=test
	expected = test.StringToJSONMap(`{
	...
	//https://www.paydex.org/laboratory/#xdr-viewer?input=AAAAAGySS3ZylffFaVZqZD6lNCUjCizHz7MLPwkN7Mxh4XN5AAAAZAAAAAAAAAB7AAAAAQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAQAAAAAAAAAKAAAACXRlc3RfZGF0YQAAAAAAAAEAAAAGAQIDBAUGAAAAAAAAAAAAAZ%2BNtPwAAABAHv%2BHVBeU%2B2Cz6xpleNt3sKt%2BK%2FRCEbp349iBKnXbBz3fu4vy0UiZPMDpBJF3weCryacTXP0JxH47eQUmwCm1AA%3D%3D&type=TransactionEnvelope&network=test
	expected = test.StringToJSONMap(`{
