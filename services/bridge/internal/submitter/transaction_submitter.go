...
// TransactionSubmitter submits transactions to Paydex Network
...
// LoadAccount loads current state of Paydex account and creates a map entry if it didn't exist
...
// SubmitTransaction builds and submits transaction to Paydex network
