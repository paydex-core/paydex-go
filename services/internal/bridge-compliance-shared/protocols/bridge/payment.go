...
import (
	...
	"github.com/paydex-core/paydex-go/services/internal/bridge-compliance-shared/http/helpers"
	"github.com/paydex-core/paydex-go/services/internal/bridge-compliance-shared/protocols"
	complianceServer "github.com/paydex-core/paydex-go/services/internal/bridge-compliance-shared/protocols/compliance"
...
var (
	...
	PaymentCannotResolveDestination = &helpers.ErrorResponse{Code: "cannot_resolve_destination", Message: "Cannot resolve federated Paydex address.", Status: http.StatusBadRequest}
...
type PaymentRequest struct {
	...
	Source string `form:"source" valid:"optional,paydex_seed"`
	// Sender address (like alice*paydex.org)
	Sender string `form:"sender" valid:"optional,paydex_address"`
	// Destination address (like bob*paydex.org)
	Destination string `form:"destination" valid:"optional,paydex_destination"`
	// ForwardDestination
	...
	Amount string `form:"amount" valid:"required,paydex_amount"`
	// Code of the asset destination should receive
	AssetCode string `form:"asset_code" valid:"optional,paydex_asset_code"`
	// Issuer of the asset destination should receive
	AssetIssuer string `form:"asset_issuer" valid:"optional,paydex_accountid"`
	// Only for path_payment
	SendMax string `form:"send_max" valid:"optional,paydex_amount"`
	// Only for path_payment
	SendAssetCode string `form:"send_asset_code" valid:"optional,paydex_asset_code"`
	// Only for path_payment
	SendAssetIssuer string `form:"send_asset_issuer" valid:"optional,paydex_accountid"`
