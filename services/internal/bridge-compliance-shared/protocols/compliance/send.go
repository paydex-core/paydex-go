...
type SendRequest struct {
	...
	// Source account ID
	Source string `form:"source" valid:"required,paydex_accountid"`
	// Sender address (like alice*paydex.org)
	Sender string `form:"sender" valid:"required,paydex_address"`
	// Destination address (like bob*paydex.org)
	Destination string `form:"destination" valid:"required,paydex_address"`
	// ForwardDestination
