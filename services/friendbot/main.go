...
import (
	...
	"github.com/paydex-core/paydex-go/services/friendbot/internal"
	"github.com/paydex-core/paydex-go/support/app"
	"github.com/paydex-core/paydex-go/support/config"
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "friendbot",
		Short: "friendbot for the Paydex Test Network",
		Long:  "client-facing api server for the friendbot service on the Paydex Test Network",
		Run:   run,
	}
