...
import (
	...
	"github.com/paydex-core/paydex-go/handlers/federation"
...
func main() {
	rootCmd := &cobra.Command{
		Use:   "federation",
		Short: "paydex federation server",
		Long: `
The paydex federation server let's you easily integrate the paydex federation
