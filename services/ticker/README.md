# Ticker
This project aims to provide an easy-to-deploy Paydex ticker.
...
2. Clone the [monorepo](https://github.com/paydex-core/paydex-go) and `$ cd services/ticker`
...
2. Run the ticker with the mounted folder: `$ docker run --rm -it -p "8000:8000" -v
   "/path/to/data/folder:/opt/paydex/postgresql" ticker` (you'll also be asked to enter a
