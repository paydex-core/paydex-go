...
import (
	...
	"github.com/paydex-core/paydex-go/services/ticker/internal/utils"
)
...
func shouldDiscardAsset(asset hProtocol.AssetStat, shouldValidateTOML bool) bool {
	...
	// [PaydexX Ticker]: assets need at least some adoption to show up
	...
	// [PaydexX Ticker]: assets with at least 100 accounts get a pass,
	...
	if shouldValidateTOML {
		...
		// [PaydexX Ticker]: TOML files should be hosted on HTTPS
...
func fetchTOMLData(asset hProtocol.AssetStat) (data string, err error) {
	...
	req.Header.Set("User-Agent", "Paydex Ticker v1.0")
