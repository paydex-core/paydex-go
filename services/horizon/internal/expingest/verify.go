...
import (
	...
	ingesterrors "github.com/paydex-core/paydex-go/exp/ingest/errors"
	"github.com/paydex-core/paydex-go/exp/ingest/io"
	"github.com/paydex-core/paydex-go/exp/ingest/verify"
	...
	"github.com/paydex-core/paydex-go/services/horizon/internal/expingest/processors"
	"github.com/paydex-core/paydex-go/support/errors"
	"github.com/paydex-core/paydex-go/support/historyarchive"
	logpkg "github.com/paydex-core/paydex-go/support/log"
...
func (s *System) verifyState(graphOffers map[xdr.Int64]xdr.OfferEntry) error {
	...
	localLog.Info("Starting state verification. Waiting 40 seconds for paydex-core to publish HAS...")
	select {
	case <-s.shutdown:
		localLog.Info("State verifier shut down...")
		return nil
	case <-time.After(40 * time.Second):
		// Wait for paydex-core to publish HAS
	}
