...
import (
	...
	protocolEffects "github.com/paydex-core/paydex-go/protocols/horizon/effects"
...
func Test_ingestSignerEffects(t *testing.T) {
	...
	// Regression: https://github.com/paydex-core/paydex-go/horizon/issues/390 doesn't produce a signer effect when
