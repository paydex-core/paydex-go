...
import (
	...
	"github.com/paydex-core/paydex-go/meta"
	"github.com/paydex-core/paydex-go/services/horizon/internal/db2/history"
	"github.com/paydex-core/paydex-go/services/horizon/internal/ingest/participants"
	"github.com/paydex-core/paydex-go/support/errors"
	ilog "github.com/paydex-core/paydex-go/support/log"
	sTime "github.com/paydex-core/paydex-go/support/time"
...
func (is *Session) ingestEffects() {
	...
	case xdr.OperationTypeCreatePassiveSellOffer:
		...
		// KNOWN ISSUE:  paydex-core creates results for CreatePassiveOffer operations
...
func (is *Session) ingestTrades() {
	...
	for i, trade := range trades {
		// paydex-core will opportunisticly garbage collect invalid offers (in the
...
// reportCursorState makes an http request to the configured paydex-core server
// to report that it has finished processing the data being ingested.  This
// allows paydex-core to free that storage when next it runs its own
// maintenance.
func (is *Session) reportCursorState() error {
	...
	core := &paydexcore.Client{URL: is.PaydexCoreURL}
