...
import (
	...
	"github.com/paydex-core/paydex-go/services/horizon/internal/db2/sqx"
	"github.com/paydex-core/paydex-go/services/horizon/internal/test"
	testDB "github.com/paydex-core/paydex-go/services/horizon/internal/test/db"
...
func TestAssetStatsIngest(t *testing.T) {
	...
	tt.Assert.Equal(AssetStatResult{
		...
		NumAccounts: 1,
		Flags:       1,
		Toml:        "https://test.com/.well-known/paydex.toml",
	}, assetStats[0])
