...
If you are encountering this error on the public Paydex infrastructure, please
report an error on [Horizon's issue tracker](https://github.com/paydex-core/paydex-go/issues)
...
```json
{
  "type": "https://paydex.org/horizon-errors/server_error",
  "title": "Internal Server Error",
  "status": 500,
