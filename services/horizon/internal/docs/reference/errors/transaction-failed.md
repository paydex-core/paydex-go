...
| `result_xdr`               | String | A base64-encoded representation of the TransactionResult XDR returned by paydex-core when submitting this transaction.     |
| `result_codes.transaction` | String | The transaction result code returned by Paydex Core.                                                                       |
