...
People on the Paydex network can make [offers](../resources/offer.md) to buy or sell assets. When
...
for new trades as they occur on the Paydex network.
...
```sh
curl https://horizon.paydex.org/trades?base_asset_type=native&counter_asset_code=SLT&counter_asset_issuer=GCKA6K5PCQ6PNF5RQBF7PQDJWRHO6UOGFMRLK3DYHDOI244V47XKQ4GP&counter_asset_type=credit_alphanum4&limit=2&order=desc
```
...
```json
{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex.org/trades?cursor=&limit=10&order=asc"
    },
    "next": {
      "href": "https://horizon-testnet.paydex.org/trades?cursor=6025839120434-0&limit=10&order=asc"
    },
    "prev": {
      "href": "https://horizon-testnet.paydex.org/trades?cursor=6012954218535-0&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          ...
          "operation": {
            "href": "https://horizon-testnet.paydex.org/operations/6012954218535"
          }
        },
        "id": "6012954218535-0",
      ...
      },
      {
        "_links": {
          ...
          "operation": {
            "href": "https://horizon-testnet.paydex.org/operations/6025839120385"
          }
        },
        "id": "6025839120385-0",
