...
clientData:
  laboratoryUrl: https://www.paydex.org/laboratory/#explorer?resource=operations&endpoint=all
---
...
This endpoint can also be used in [streaming](../streaming.md) mode so it is possible to use it to listen as operations are processed in the Paydex network.
...
```sh
curl "https://horizon-testnet.paydex.org/operations?limit=200&order=desc"
```
