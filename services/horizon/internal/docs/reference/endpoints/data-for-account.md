...
clientData:
  laboratoryUrl: https://www.paydex.org/laboratory/#explorer?resource=data&endpoint=for_account
---
...
```sh
curl "https://horizon-testnet.paydex.org/accounts/GA2HGBJIJKI6O4XEM7CZWY5PS6GKSXL6D34ERAJYQSPYA6X6AI7HYW36/data/user-id"
```
