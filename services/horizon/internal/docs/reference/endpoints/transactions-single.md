...
clientData:
  laboratoryUrl: https://www.paydex.org/laboratory/#explorer?resource=transactions&endpoint=single
---
...
Transaction can be successful or failed (failed transactions are also included in Paydex ledger).
...
```sh
curl "https://horizon-testnet.paydex.org/transactions/264226cb06af3b86299031884175155e67a02e0a8ad0b3ab3a88b409a8c09d5c"
```
