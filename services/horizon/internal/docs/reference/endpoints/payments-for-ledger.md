...
clientData:
  laboratoryUrl: https://www.paydex.org/laboratory/#explorer?resource=payments&endpoint=for_ledger
---
...
```sh
curl "https://horizon-testnet.paydex.org/ledgers/696960/payments?limit=1"
```
...
```json
{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex.org/ledgers/696960/payments?cursor=&limit=1&order=asc"
    },
    "next": {
      "href": "https://horizon-testnet.paydex.org/ledgers/696960/payments?cursor=2993420406628353&limit=1&order=asc"
    },
    "prev": {
      "href": "https://horizon-testnet.paydex.org/ledgers/696960/payments?cursor=2993420406628353&limit=1&order=desc"
    }
  },
  "_embedded": {
    "records": [
