...
title: All Payments
clientData:
  laboratoryUrl: https://www.paydex.org/laboratory/#explorer?resource=payments&endpoint=all
---
...
get made in the Paydex network.
...
curl "https://horizon-testnet.paydex.org/payments?limit=200"
```

```sh
# Retrieve a page of payments to occur immediately before the transaction
# specified by the paging token "1234".
curl "https://horizon-testnet.paydex.org/payments?cursor=1234&order=desc"
```
