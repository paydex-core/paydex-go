...
clientData:
  laboratoryUrl: https://www.paydex.org/laboratory/#explorer?resource=paths&endpoint=all
---

The Paydex Network allows payments to be made across assets through _path payments_.  A path
...
```
https://horizon-testnet.paydex.org/paths/strict-send?&source_amount={sa}&source_asset_type={at}&source_asset_code={ac}&source_asset_issuer={ai}&destination_account={da}
```
...
```sh
curl "https://horizon-testnet.paydex.org/paths/strict-send?&source_amount=10&source_asset_type=native&destination_assets=MXN:GC2GFGZ5CZCFCDJSQF3YYEAYBOS3ZREXJSPU7LUJ7JU3LP3BQNHY7YKS"
```
...
var sourceAsset = PaydexSdk.Asset.native();
var sourceAmount = "20";
var destinationAsset = new PaydexSdk.Asset(
  'USD',
