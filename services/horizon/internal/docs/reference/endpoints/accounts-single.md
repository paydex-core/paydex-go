...
clientData:
  laboratoryUrl: https://www.paydex.org/laboratory/#explorer?resource=accounts&endpoint=single
---
...
[trustlines](https://www.paydex.org/developers/learn/concepts/assets.html) this account
...
[authorization required](https://www.paydex.org/developers/guides/concepts/accounts.html#flags)
flag set, the trustline won't show up until account `B`
[allows](https://www.paydex.org/developers/guides/concepts/list-of-operations.html#allow-trust)
...
```sh
curl "https://horizon-testnet.paydex.org/accounts/GD42RQNXTRIW6YR3E2HXV5T2AI27LBRHOERV2JIYNFMXOBA234SWLQQB"
```
