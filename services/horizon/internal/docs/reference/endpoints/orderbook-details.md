...
clientData:
  laboratoryUrl: https://www.paydex.org/laboratory/#explorer?resource=order_book&endpoint=details
---

People on the Paydex network can make [offers](../resources/offer.md) to buy or sell assets.
...
```sh
curl "https://horizon-testnet.paydex.org/order_book?selling_asset_type=native&buying_asset_type=credit_alphanum4&buying_asset_code=FOO&buying_asset_issuer=GBAUUA74H4XOQYRSOW2RZUA4QL5PB37U3JS5NE3RTB2ELJVMIF5RLMAG&limit=20"
```
...
server.orderbook(new PaydexSdk.Asset.native(), new PaydexSdk.Asset('FOO', 'GBAUUA74H4XOQYRSOW2RZUA4QL5PB37U3JS5NE3RTB2ELJVMIF5RLMAG'))
  .call()
  .then(function(resp) {
    console.log(resp);
  })
...
var es = server.orderbook(new PaydexSdk.Asset.native(), new PaydexSdk.Asset('FOO', 'GBAUUA74H4XOQYRSOW2RZUA4QL5PB37U3JS5NE3RTB2ELJVMIF5RLMAG'))
  .cursor('now')
  .stream({
