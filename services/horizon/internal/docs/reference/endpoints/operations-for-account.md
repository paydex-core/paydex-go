...
clientData:
  laboratoryUrl: https://www.paydex.org/laboratory/#explorer?resource=operations&endpoint=for_account
---
...
```sh
curl "https://horizon-testnet.paydex.org/accounts/GA2HGBJIJKI6O4XEM7CZWY5PS6GKSXL6D34ERAJYQSPYA6X6AI7HYW36/operations"
```

### JavaScript Example Request

```js
var PaydexSdk = require('pyadex-sdk');
