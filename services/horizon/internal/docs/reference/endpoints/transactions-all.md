...
clientData:
  laboratoryUrl: https://www.paydex.org/laboratory/#explorer?resource=transactions&endpoint=all
---
...
it to listen for new transactions as they get made in the Paydex network. If called in streaming
...
curl "https://horizon-testnet.paydex.org/transactions?limit=200&order=desc"
```
