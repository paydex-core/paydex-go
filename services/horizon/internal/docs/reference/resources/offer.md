...
Accounts on the Paydex network can make [offers](http://paydex.org/developers/learn/concepts/exchange.html) to buy or sell assets.  Users can create offers with the [Manage Offer](http://paydex.org/developers/learn/concepts/list-of-operations.html) operation.
...
| selling     | [Asset](http://paydex.org/developers/learn/concepts/assets.html)           | The Asset this offer wants to sell.                      |
| buying     | [Asset](http://paydex.org/developers/learn/concepts/assets.html) | The Asset this offer wants to buy. |
