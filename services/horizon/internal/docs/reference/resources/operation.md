...
[Operations](https://www.paydex.org/developers/learn/concepts/operations.html) are objects that represent a desired change to the ledger: payments,
offers to exchange currency, changes made to account options, etc.  Operations
are submitted to the Paydex network grouped in a [Transaction](./transaction.md).

To learn more about the concept of operations in the Paydex network, take a look at the [Paydex operations concept guide](https://www.paydex.org/developers/learn/concepts/operations.html).

## Operation Types

| type                                          | type_i | description                                                                                                |
|-----------------------------------------------|--------|------------------------------------------------------------------------------------------------------------|
| [CREATE_ACCOUNT](#create-account)                       | 0      | Creates a new account in Paydex network.
| [PAYMENT](#payment)                                     | 1      | Sends a simple payment between two accounts in Paydex network.
| [PATH_PAYMENT](#path-payment)                           | 2      | Sends a path payment between two accounts in the Paydex network.
| [MANAGE_SELL_OFFER](#manage-sell-offer)                 | 3      | Creates, updates or deletes a sell offer in the Paydex network.
| [MANAGE_BUY_OFFER](#manage-buy-offer)                   | 12     | Creates, updates or deletes a buy offer in the Paydex network.
...
offer to trade assets in the Paydex network.
