...
**Assets** are the units that are traded on the Paydex Network.

An asset consists of an type, code, and issuer.

To learn more about the concept of assets in the Paydex network, take a look at the [Paydex assets concept guide](https://www.paydex.org/developers/guides/concepts/assets.html).
...
|--------------|---------------------------------------------------------------------------------------------------|------------------------------------------------------------
| toml  | `https://www.paydex.org/.well-known/paydex.toml`| Link to the TOML file for this issuer |
...
```json
{
  "_links": {
    "toml": {
      "href": "https://www.paydex.org/.well-known/paydex.toml"
    }
  },
