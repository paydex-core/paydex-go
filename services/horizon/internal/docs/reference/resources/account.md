...
In the Paydex network, users interact using **accounts** which can be controlled by a corresponding keypair that can authorize transactions. One can create a new account with the [Create Account](./operation.md#create-account) operation.

To learn more about the concept of accounts in the Paydex network, take a look at the [Paydex account concept guide](https://www.paydex.org/developers/learn/concepts/accounts.html).
...
| subentry_count | number           | The number of [account subentries](https://www.paydex.org/developers/guides/concepts/ledger.html#ledger-entries).                           |
...
| signers        | array of objects | An array of [account signers](https://www.paydex.org/developers/guides/concepts/multi-sig.html#additional-signing-keys) with their weights. |
...
| Type         | Description |
|--------------|-------------|
| ed25519_public_key | A normal Paydex public key. |
...
| asset_issuer     | optional, string           | The paydex address of the given asset's issuer.  |
...
[account_merge]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#account-merge
[allow_trust]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#allow-trust
[bump_seq]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#bump-sequence
[change_trust]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#change-trust
[create_acc]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#create-account
[inflation]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#inflation
[manage_data]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#manage-data
[manage_buy_offer]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#manage-buy-offer
[manage_sell_offer]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#manage-sell-offer
[passive_sell_offer]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#create-passive-sell-offer
[path_payment]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#path-payment
[payment]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#payment
[set_options]: https://www.paydex.org/developers/guides/concepts/list-of-operations.html#set-options
...
```json
{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex.org/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW"
    },
    "transactions": {
      "href": "https://horizon-testnet.paydex.org/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/transactions{?cursor,limit,order}",
      "templated": true
    },
    "operations": {
      "href": "https://horizon-testnet.paydex.org/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/operations{?cursor,limit,order}",
      "templated": true
    },
    "payments": {
      "href": "https://horizon-testnet.paydex.org/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/payments{?cursor,limit,order}",
      "templated": true
    },
    "effects": {
      "href": "https://horizon-testnet.paydex.org/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/effects{?cursor,limit,order}",
      "templated": true
    },
    "offers": {
      "href": "https://horizon-testnet.paydex.org/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/offers{?cursor,limit,order}",
      "templated": true
    },
    "trades": {
      "href": "https://horizon-testnet.paydex.org/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/trades{?cursor,limit,order}",
      "templated": true
    },
    "data": {
      "href": "https://horizon-testnet.paydex.org/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/data/{key}",
      "templated": true
    }
  },
