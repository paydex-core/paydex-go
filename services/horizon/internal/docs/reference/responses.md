...
The above response is for the genesis ledger of the Paydex test network, and
...
Over time there will be millions of transactions in the Paydex network's ledger
