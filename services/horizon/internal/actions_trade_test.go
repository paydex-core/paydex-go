...
import (
	...
	. "github.com/paydex-core/paydex-go/services/horizon/internal/db2/history"
	. "github.com/paydex-core/paydex-go/services/horizon/internal/test/trades"
	"github.com/paydex-core/paydex-go/support/render/hal"
	PaydexTime "github.com/paydex-core/paydex-go/support/time"
...
func TestTradeActions_AmountsExceedInt64(t *testing.T) {
	...
	for i := 1; i <= 3; i++ {
		timestamp := paydexTime.MillisFromInt64(start + (minute * int64(i-1)))
		err := IngestTestTrade(
...
func TestTradeActions_IndexRegressions(t *testing.T) {
	t.Run("Regression:  https://github.com/paydex-core/paydex-go/services/horizon/internal/issues/318", func(t *testing.T) {
		ht := StartHTTPTest(t, "trades")
		defer ht.Finish()
	...
	t.Run("Regression for nil prices: https://github.com/paydex-core/paydex-go/issues/357", func(t *testing.T) {
		ht := StartHTTPTest(t, "trades")
		defer ht.Finish()
...
// https://github.com/paydex-core/paydex-go/issues/215
