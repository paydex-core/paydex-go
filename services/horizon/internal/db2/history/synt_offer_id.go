...
//
// This is required because paydex-core does not allocate offer ids for immediately filled offers,
// while clients expect them for aggregated views.
//
// The encoded value is of type int64 for sql compatibility. The 2nd bit is used to differentiate between paydex-core
