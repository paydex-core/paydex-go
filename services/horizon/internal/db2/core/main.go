...
// reading rows from a Paydex Core db
package core
...
// Offer is row of data from the `offers` table from paydex-core
type Offer struct {
...
// internalOffer is row of data from the `offers` table from paydex-core used
...
// Q is a helper struct on which to hang common queries against a paydex
// core database.
type Q struct {
	*db.Session
}
...
// Signer is a row of data from the `signers` table from paydex-core
type Signer struct {
	Accountid string
	Publickey string
	Weight    int32
...
// Transaction is row of data from the `txhistory` table from paydex-core
...
// TransactionFee is row of data from the `txfeehistory` table from paydex-core
...
// Trustline is a row of data from the `trustlines` table from paydex-core
...
// paydex-core database this ingestion system is communicating with.  Horizon,
