...
// be submitted to the backing paydex-core process, as well as looking up the status
...
// Submitter represents the low-level "submit a transaction to paydex-core"
// provider.
type Submitter interface {
	// Submit sends the provided transaction envelope to paydex-core
