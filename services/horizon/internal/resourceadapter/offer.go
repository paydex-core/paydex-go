...
// takes an offer row from the paydex core database. Once the experimental horizon ingestion system
// is fully rolled out there will be no need to query offers from the paydex core database and
