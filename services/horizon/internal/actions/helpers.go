...
import (
	...
	"github.com/paydex-core/paydex-go/services/horizon/internal/assets"
	...
	"github.com/paydex-core/paydex-go/services/horizon/internal/toid"
	...
	"github.com/paydex-core/paydex-go/support/time"
...
// GetAddress retrieves a paydex address.  It confirms the value loaded is a
// valid paydex address, setting an invalid field error if it is not.
...
// GetAccountID retireves an xdr.AccountID by attempting to decode a paydex
...
// the string at the provided name in accordance with the paydex client
