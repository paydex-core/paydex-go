// Package ledger provides useful utilities concerning ledgers within paydex,
// specifically as a central location to store a cached snapshot of the state of
// both horizon's and paydex-core's views of the ledger.  This package is
...
// State represents a snapshot of both horizon's and paydex-core's view of the
// ledger.
type State struct {
