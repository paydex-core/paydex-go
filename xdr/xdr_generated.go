...
//
//  Paydex-SCP.x
//  Paydex-ledger-entries.x
//  Paydex-ledger.x
//  Paydex-overlay.x
//  Paydex-transaction.x
//  Paydex-types.x
//
...
import (
	...
	"github.com/paydex-core/go-xdr/xdr3"
)
...
// PaydexValueType is an XDR Enum defines as:
//
...
const (
	PaydexValueTypePaydexValueBasic  PaydexValueType = 0
	PaydexValueTypePaydexValueSigned PaydexValueType = 1
)
...
// ValidEnum validates a proposed value for this enum.  Implements
// the Enum interface for PaydexValueType
func (e PaydexValueType) ValidEnum(v int32) bool {
	_, ok := paydexValueTypeMap[v]
	return ok
}

// String returns the name of `e`
func (e PaydexValueType) String() string {
	name, _ := paydexValueTypeMap[int32(e)]
	return name
}

// MarshalBinary implements encoding.BinaryMarshaler.
func (s PaydexValueType) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *PaydexValueType) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*PaydexValueType)(nil)
	_ encoding.BinaryUnmarshaler = (*PaydexValueType)(nil)
)
...
// PaydexValueExt is an XDR NestedUnion defines as:
//
...
// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u PaydexValueExt) SwitchFieldName() string {
	return "V"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of PaydexValueExt
func (u PaydexValueExt) ArmForSwitch(sw int32) (string, bool) {
	switch PaydexValueType(sw) {
	case PaydexValueTypePaydexValueBasic:
		return "", true
	case PaydexValueTypePaydexValueSigned:
		return "LcValueSignature", true
	}
	return "-", false
}

// NewPaydexValueExt creates a new  PaydexValueExt.
func NewPaydexValueExt(v PaydexValueType, value interface{}) (result PaydexValueExt, err error) {
	result.V = v
	switch PaydexValueType(v) {
	case PaydexValueTypePaydexValueBasic:
		// void
	case PaydexValueTypePaydexValueSigned:
...
// panicing if the value is not set.
func (u PaydexValueExt) MustLcValueSignature() LedgerCloseValueSignature {
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexValueExt) GetLcValueSignature() (result LedgerCloseValueSignature, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.V))
...
var (
	_ encoding.BinaryMarshaler   = (*PaydexValueExt)(nil)
	_ encoding.BinaryUnmarshaler = (*PaydexValueExt)(nil)
)

// PaydexValue is an XDR Struct defines as:
//
//   struct PaydexValue
//    {
...
var (
	_ encoding.BinaryMarshaler   = (*PaydexValue)(nil)
	_ encoding.BinaryUnmarshaler = (*PaydexValue)(nil)
)
...
//        PaydexValue scpValue;   // what consensus agreed to
...
// PaydexMessage is an XDR Union defines as:
//
...
// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u PaydexMessage) SwitchFieldName() string {
	return "Type"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of PaydexMessage
func (u PaydexMessage) ArmForSwitch(sw int32) (string, bool) {
...
// NewPaydexMessage creates a new  PaydexMessage.
func NewPaydexMessage(aType MessageType, value interface{}) (result PaydexMessage, err error) {
	result.Type = aType
...
// panicing if the value is not set.
func (u PaydexMessage) MustError() Error {
	val, ok := u.GetError()
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetError() (result Error, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u PaydexMessage) MustHello() Hello {
	val, ok := u.GetHello()
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetHello() (result Hello, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u PaydexMessage) MustAuth() Auth {
	val, ok := u.GetAuth()
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetAuth() (result Auth, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u PaydexMessage) MustDontHave() DontHave {
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetDontHave() (result DontHave, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u PaydexMessage) MustPeers() []PeerAddress {
	val, ok := u.GetPeers()
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetPeers() (result []PeerAddress, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u PaydexMessage) MustTxSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetTxSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u PaydexMessage) MustTxSet() TransactionSet {
	val, ok := u.GetTxSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetTxSet() (result TransactionSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u PaydexMessage) MustTransaction() TransactionEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetTransaction() (result TransactionEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u PaydexMessage) MustQSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetQSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u PaydexMessage) MustQSet() ScpQuorumSet {
	val, ok := u.GetQSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetQSet() (result ScpQuorumSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u PaydexMessage) MustEnvelope() ScpEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetEnvelope() (result ScpEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u PaydexMessage) MustGetScpLedgerSeq() Uint32 {
...
// returning ok if the union's switch indicated the value is valid.
func (u PaydexMessage) GetGetScpLedgerSeq() (result Uint32, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
var (
	_ encoding.BinaryMarshaler   = (*PaydexMessage)(nil)
	_ encoding.BinaryUnmarshaler = (*PaydexMessage)(nil)
)
