...
Welcome to the Paydex Go monorepo. These instructions help launch 🚀 you into making and testing code changes to this repository.
...
```
git clone https://github.com/paydex-core/paydex-go
```
...
[golistcmp]: https://github.com/paydex/golistcmp
