...
import (
	...
	"github.com/paydex-core/paydex-go/build"
...
func TestValidateError(t *testing.T) {
	...
	authData := &AuthData{
		Sender:         "bartekpaydex.org",
		NeedInfo:       false,
		Tx:             "&^%",
		AttachmentJSON: "abc",
	}

	assert.EqualError(t, authData.Validate(), "sender: bartekpaydex.org does not validate as paydex_address;tx: &^% does not validate as base64;attachment: abc does not validate as json")
}
