...
// GetAccountID returns the Paydex account ID. This is to satisfy the
...
type Root struct {
	...
	PaydexCoreVersion            string `json:"core_version"`
...
type Metrics struct {
	...
	CoreLatestLedger       SingleMetric   `json:"paydex_core.latest_ledger"`
	CoreOpenConnections    SingleMetric   `json:"paydex_core.open_connections"`
...
// To do: implement fee suggestions if agreement is reached in https://github.com/paydex-core/paydex-go/issues/926
