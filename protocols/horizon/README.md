...
- [JS SDK 0.10.2](https://github.com/paydex/js-paydex-sdk/releases/tag/v0.10.2)
- [Java SDK 0.4.0](https://github.com/paydex/java-paydex-sdk/releases/tag/0.4.0)
...
* In ["Offers for Account"](https://www.paydex.org/developers/horizon/reference/endpoints/offers-for-account.html),
`last_modified_time` field  endpoint can be `null` when ledger data is not available (has not been ingested yet).
* ["Trades for Offer"](https://www.paydex.org/developers/horizon/reference/endpoints/trades-for-offer.html) endpoint
will query for trades that match the given offer on either side of trades, rather than just the "sell" offer.
Offer IDs are now [synthetic](https://www.paydex.org/developers/horizon/reference/resources/trade.html#synthetic-offer-ids).
* New `/operation_fee_stats` endpoint includes fee stats for the last 5 ledgers.
* ["Trades"](https://www.paydex.org/developers/horizon/reference/endpoints/trades.html) endpoint can now be streamed.
* In ["Trade Aggregations"](https://www.paydex.org/developers/horizon/reference/endpoints/trade_aggregations.html) endpoint,
...
- [JS SDK 0.10.2](https://github.com/paydex/js-paydex-sdk/releases/tag/v0.10.2)
- [Java SDK 0.3.1](https://github.com/paydex/java-paydex-sdk/releases/tag/0.3.1)

#### Changes

* New [`bump_sequence`](https://www.paydex.org/developers/horizon/reference/resources/operation.html#bump-sequence) operation.
...
- [JS SDK 0.8.2](https://github.com/paydex/js-paydex-sdk/releases/tag/v0.8.2)
- [Java SDK 0.2.1](https://github.com/paydex/java-paydex-sdk/releases/tag/0.2.1)

#### Changes

- `amount` field in `/assets` is now a String (to support Paydex amounts larger than `int64`).
