...
import (
	...
	"github.com/paydex-core/paydex-go/crc16"
...
const (
	//VersionByteAccountID is the version byte used for encoded paydex addresses
	VersionByteAccountID VersionByte = 6 << 3 // Base32-encodes to 'G...'

	//VersionByteSeed is the version byte used for encoded paydex seed
	VersionByteSeed = 18 << 3 // Base32-encodes to 'S...'

	//VersionByteHashTx is the version byte used for encoded paydex hashTx
	//signer keys.
	VersionByteHashTx = 19 << 3 // Base32-encodes to 'T...'

	//VersionByteHashX is the version byte used for encoded paydex hashX
	//signer keys.
...
// IsValidEd25519PublicKey validates a paydex public key
...
// IsValidEd25519SecretSeed validates a paydex secret key
