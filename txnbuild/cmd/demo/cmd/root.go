...
var rootCmd = &cobra.Command{
	Use:   "demo",
	Short: "Exercise the Paydex Go SDK (horizonclient + txnbuild)",
	Long: `This CLI is a working demonstration of the Paydex Go SDK. The SDK is used to interact
with the Paydex network. It can retrieve information about the state of the network, and can
