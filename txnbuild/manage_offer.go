...
import (
	...
	"github.com/paydex-core/paydex-go/price"
...
func DeleteOfferOp(offerID int64, sourceAccount ...Account) (ManageSellOffer, error) {
	// It turns out Paydex core doesn't care about any of these fields except the amount.
...
// ManageSellOffer represents the Paydex manage offer operation. See
