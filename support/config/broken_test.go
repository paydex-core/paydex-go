...
func TestOptionalPaydexFields(t *testing.T) {
	var val struct {
		F1 string `valid:"paydex_accountid,optional"`
		F2 string `valid:"optional,paydex_accountid"`
		F3 string `valid:"paydex_seed,optional"`
		F4 string `valid:"optional,paydex_accountid"`
	}
