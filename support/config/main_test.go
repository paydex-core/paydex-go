...
func TestAccountIDValidator(t *testing.T) {
	var val struct {
		Empty        string `valid:"paydex_accountid"`
		NotSTRKey    string `valid:"paydex_accountid"`
		NotAccountID string `valid:"paydex_accountid"`
		Valid        string `valid:"paydex_accountid"`
		WrongType    int    `valid:"paydex_accountid"`
	}
...
func TestSeedValidator(t *testing.T) {
	var val struct {
		Empty     string `valid:"paydex_seed"`
		NotSTRKey string `valid:"paydex_seed"`
		NotSeed   string `valid:"paydex_seed"`
		Valid     string `valid:"paydex_seed"`
		WrongType int    `valid:"paydex_seed"`
	}
