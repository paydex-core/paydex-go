// Copyright 2016 Paydex Development Foundation and contributors. Licensed
...
func TestHashValidation(t *testing.T) {
	...
	// https://horizon.paydex.org/ledgers/24088895
	// http://history.paydex.org/prd/core-live/core_live_001/history/01/6f/91/history-016f913f.json
	var jsonBlob = []byte(`{
    "version": 1,
    "server": "v11.1.0",
