...
import (
	...
	"github.com/paydex-core/paydex-go/support/test"
...
func TestRender(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			P{Extras: map[string]interface{}{"hello": "paydex"}},
			[]string{"hello", "paydex"},
			0,
		},
	}
...
func TestInflate(t *testing.T) {
	testCase := struct {
		...
		"renders the type correctly",
		P{Type: "https://paydex.org/horizon-errors/not_found"},
		"https://paydex.org/horizon-errors/not_found",
	}
