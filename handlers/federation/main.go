// Package federation provides a pluggable handler that satisfies the Paydex
...
type Driver interface {
	...
	// federation request to lookup a `Record` using the provided paydex address.
...
// conform to the Paydex federation protocol.  This handler should be added to
...
type ReverseSQLDriver struct {
	...
	// paydex account id to lookup, such as
