// Package address provides utility functions for working with paydex
// addresses. See https://www.paydex.org/developers/guides/concepts/federation.
// html#paydex-addresses for more on addresses.
package address
