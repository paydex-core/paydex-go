...
var accountMergeEffectsResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex-go.org/operations/43989725060534273/effects?cursor=&limit=10&order=asc"
    },
    "next": {
      "href": "https://horizon-testnet.paydex-go.org/operations/43989725060534273/effects?cursor=43989725060534273-3&limit=10&order=asc"
    },
    "prev": {
      "href": "https://horizon-testnet.paydex-go.org/operations/43989725060534273/effects?cursor=43989725060534273-1&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          "operation": {
            "href": "https://horizon-testnet.paydex-go.org/operations/43989725060534273"
          },
          "succeeds": {
            "href": "https://horizon-testnet.paydex-go.org/effects?order=desc&cursor=43989725060534273-1"
          },
          "precedes": {
            "href": "https://horizon-testnet.paydex-go.org/effects?order=asc&cursor=43989725060534273-1"
          }
        },
      ...
      },
      {
        "_links": {
          ...
          "succeeds": {
            "href": "https://horizon-testnet.paydex-go.org/effects?order=desc&cursor=43989725060534273-2"
          },
          "precedes": {
            "href": "https://horizon-testnet.paydex-go.org/effects?order=asc&cursor=43989725060534273-2"
          }
        },
      ...
      },
      {
        "_links": {
          ...
          "succeeds": {
            "href": "https://horizon-testnet.paydex-go.org/effects?order=desc&cursor=43989725060534273-3"
          },
          "precedes": {
            "href": "https://horizon-testnet.paydex-go.org/effects?order=asc&cursor=43989725060534273-3"
          }
        },
...
var accountResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex-go.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H"
    },
    "transactions": {
      "href": "https://horizon-testnet.paydex-go.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H/transactions{?cursor,limit,order}",
      "templated": true
    },
    "operations": {
      "href": "https://horizon-testnet.paydex-go.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H/operations{?cursor,limit,order}",
      "templated": true
    },
    "payments": {
      "href": "https://horizon-testnet.paydex-go.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H/payments{?cursor,limit,order}",
      "templated": true
    },
    "effects": {
      "href": "https://horizon-testnet.paydex-go.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H/effects{?cursor,limit,order}",
      "templated": true
    },
    "offers": {
      "href": "https://horizon-testnet.paydex-go.org/accounts/GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H/Offers{?cursor,limit,order}",
      "templated": true
    }
  },
...
var accountOffersResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon.paydex-go.org/accounts/GC2BQYBXFOVPRDH35D5HT2AFVCDGXJM5YVTAF5THFSAISYOWAJQKRESK/offers?order=asc\u0026limit=10\u0026cursor="
    },
    "next": {
      "href": "https://horizon.paydex-go.org/accounts/GC2BQYBXFOVPRDH35D5HT2AFVCDGXJM5YVTAF5THFSAISYOWAJQKRESK/offers?order=asc\u0026limit=10\u0026cursor=2539"
    },
    "prev": {
      "href": "https://horizon.paydex-go.org/accounts/GC2BQYBXFOVPRDH35D5HT2AFVCDGXJM5YVTAF5THFSAISYOWAJQKRESK/offers?order=desc\u0026limit=10\u0026cursor=161"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          "self": {
            "href": "https://horizon.paydex-go.org/offers/161"
          },
          "offer_maker": {
            "href": "https://horizon.paydex-go.org/accounts/GC2BQYBXFOVPRDH35D5HT2AFVCDGXJM5YVTAF5THFSAISYOWAJQKRESK"
          }
        },
        "id": 161,
        "paging_token": "161",
      ...
      },
      {
        "_links": {
          "self": {
            "href": "https://horizon.paydex-go.org/offers/2539"
          },
          "offer_maker": {
            "href": "https://horizon.paydex-go.org/accounts/GC2BQYBXFOVPRDH35D5HT2AFVCDGXJM5YVTAF5THFSAISYOWAJQKRESK"
          }
...
var accountTransactionsResponse = `{
    "_links": {
        "self": {
            "href": "https://horizon-testnet.paydex-go.org/accounts/GCK6ALX65S5KTQRKX3OWG5DNCJ7XMI62N55TKRM6ZI2YNWDSO3PX3YSZ/transactions?cursor=\u0026limit=10\u0026order=desc"
        },
        "next": {
            "href": "https://horizon-testnet.paydex-go.org/accounts/GCK6ALX65S5KTQRKX3OWG5DNCJ7XMI62N55TKRM6ZI2YNWDSO3PX3YSZ/transactions?cursor=1966059934466048\u0026limit=10\u0026order=desc"
        },
        "prev": {
            "href": "https://horizon-testnet.paydex-go.org/accounts/GCK6ALX65S5KTQRKX3OWG5DNCJ7XMI62N55TKRM6ZI2YNWDSO3PX3YSZ/transactions?cursor=1968722814185472\u0026limit=10\u0026order=asc"
        }
    },
    "_embedded": {
        "records": [{
                "_links": {
                    "self": {
                        "href": "https://horizon-testnet.paydex-go.org/transactions/1d69be46da491ce35b1241f65fa0f7471f94bc7e87ea031264c11144245acdc1"
                    },
                    "account": {
                        "href": "https://horizon-testnet.paydex-go.org/accounts/GCK6ALX65S5KTQRKX3OWG5DNCJ7XMI62N55TKRM6ZI2YNWDSO3PX3YSZ"
                    },
                    "ledger": {
                        "href": "https://horizon-testnet.paydex-go.org/ledgers/458379"
                    },
                    "operations": {
                        "href": "https://horizon-testnet.paydex-go.org/transactions/1d69be46da491ce35b1241f65fa0f7471f94bc7e87ea031264c11144245acdc1/operations{?cursor,limit,order}",
                        "templated": true
                    },
                    "effects": {
                        "href": "https://horizon-testnet.paydex-go.org/transactions/1d69be46da491ce35b1241f65fa0f7471f94bc7e87ea031264c11144245acdc1/effects{?cursor,limit,order}",
                        "templated": true
                    },
                    "precedes": {
                        "href": "https://horizon-testnet.paydex-go.org/transactions?order=asc\u0026cursor=1968722814185472"
                    },
                    "succeeds": {
                        "href": "https://horizon-testnet.paydex-go.org/transactions?order=desc\u0026cursor=1968722814185472"
                    }
                },
            ...
            },
            {
                "_links": {
                    "self": {
                        "href": "https://horizon-testnet.paydex-go.org/transactions/a7e50a442932e75ee7a939ee828508948c9dfa36c27b939b9fd240ed491424d8"
                    },
                    "account": {
                        "href": "https://horizon-testnet.paydex-go.org/accounts/GCK6ALX65S5KTQRKX3OWG5DNCJ7XMI62N55TKRM6ZI2YNWDSO3PX3YSZ"
                    },
                    "ledger": {
                        "href": "https://horizon-testnet.paydex-go.org/ledgers/458377"
                    },
                    "operations": {
                        "href": "https://horizon-testnet.paydex-go.org/transactions/a7e50a442932e75ee7a939ee828508948c9dfa36c27b939b9fd240ed491424d8/operations{?cursor,limit,order}",
                        "templated": true
                    },
                    "effects": {
                        "href": "https://horizon-testnet.paydex-go.org/transactions/a7e50a442932e75ee7a939ee828508948c9dfa36c27b939b9fd240ed491424d8/effects{?cursor,limit,order}",
                        "templated": true
                    },
                    "precedes": {
                        "href": "https://horizon-testnet.paydex-go.org/transactions?order=asc\u0026cursor=1968714224242688"
                    },
                    "succeeds": {
                        "href": "https://horizon-testnet.paydex-go.org/transactions?order=desc\u0026cursor=1968714224242688"
                    }
                },
...
var transactionResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon.paydex-go.org/transactions/a4ca51d09610154409890763e2c8ecbaa36688c957dea1df0578bdbc1f65d312"
    },
    "account": {
      "href": "https://horizon.paydex-go.org/accounts/GBQ352ACDO6DEGI42SOI4DCB654N7B7DANO4RSBGA5CZLM4475CQNID4"
    },
    "ledger": {
      "href": "https://horizon.paydex-go.org/ledgers/17425656"
    },
    "operations": {
      "href": "https://horizon.paydex-go.org/transactions/a4ca51d09610154409890763e2c8ecbaa36688c957dea1df0578bdbc1f65d312/operations{?cursor,limit,order}",
      "templated": true
    },
    "effects": {
      "href": "https://horizon.paydex-go.org/transactions/a4ca51d09610154409890763e2c8ecbaa36688c957dea1df0578bdbc1f65d312/effects{?cursor,limit,order}",
      "templated": true
    },
    "precedes": {
      "href": "https://horizon.paydex-go.org/transactions?order=asc&cursor=74842622631374848"
    },
    "succeeds": {
      "href": "https://horizon.paydex-go.org/transactions?order=desc&cursor=74842622631374848"
    }
  },
...
var notFoundResponse = `{
  "type": "https://paydex-go.org/horizon-errors/not_found",
...
var submitResponse = `{
  "_links": {
    "transaction": {
      "href": "https://horizon-testnet.paydex-go.org/transactions/ee14b93fcd31d4cfe835b941a0a8744e23a6677097db1fafe0552d8657bed940"
    }
  },
...
var transactionFailure = `{
  "type": "https://paydex-go.org/horizon-errors/transaction_failed",
  "title": "Transaction Failed",
  "status": 400,
  "detail": "The transaction failed when submitted to the paydex-go network. The extras.result_codes field on this response contains further details.  Descriptions of each code can be found at: https://www.paydex-go.org/developers/learn/concepts/list-of-operations.html",
  "instance": "horizon-testnet-001.prd.paydex-go001.internal.paydex-go-ops.com/4elYz2fHhC-528285",
  "extras": {
...
var internalServerError = `{
  "type":     "https://www.paydex-go.org/docs/horizon/problems/server_error",
