...
func TestNextOffersPage(t *testing.T) {
	...
	hmock.On(
		"GET",
		"https://horizon-testnet.paydex.org/accounts/GBZ5OD56VRTRQKMNADD6VUZUG3FCILMAMYQY5ZSC3AW3GBXNEPIK76IG/offers?cursor=2946581&limit=2&order=asc",
    ...
    "records": [
      {
        "_links": {
          "self": {
            "href": "https://horizon-testnet.paydex.org/offers/2946580"
          },
          "offer_maker": {
      ...
      },
      {
        "_links": {
          "self": {
            "href": "https://horizon-testnet.paydex.org/offers/2946581"
          },
          "offer_maker": {
            "href": "https://horizon-testnet.paydex.org/accounts/GBZ5OD56VRTRQKMNADD6VUZUG3FCILMAMYQY5ZSC3AW3GBXNEPIK76IG"
          }
...
var emptyOffersPage = `{
  "_links": {
    ...
    "next": {
      "href": "https://horizon-testnet.paydex.org/accounts/GBZ5OD56VRTRQKMNADD6VUZUG3FCILMAMYQY5ZSC3AW3GBXNEPIK76IG/offers?cursor=2946583&limit=2&order=asc"
    },
    "prev": {
      "href": "https://horizon-testnet.paydex.org/accounts/GBZ5OD56VRTRQKMNADD6VUZUG3FCILMAMYQY5ZSC3AW3GBXNEPIK76IG/offers?cursor=2946582&limit=2&order=desc"
    }
  },
  "_embedded": {
    "records": []
