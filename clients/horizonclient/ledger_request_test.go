...
func TestNextLedgersPage(t *testing.T) {
	...
	hmock.On(
		"GET",
		"https://horizon-testnet.paydex.org/ledgers?cursor=1559012998905856&limit=2&order=desc",
    ...
    "records": [
      {
        "_links": {
          "self": {
            "href": "https://horizon-testnet.paydex.org/ledgers/362987"
          },
          "transactions": {
            "href": "https://horizon-testnet.paydex.org/ledgers/362987/transactions{?cursor,limit,order}",
            "templated": true
          },
          "operations": {
            "href": "https://horizon-testnet.paydex.org/ledgers/362987/operations{?cursor,limit,order}",
            "templated": true
          },
          "payments": {
            "href": "https://horizon-testnet.paydex.org/ledgers/362987/payments{?cursor,limit,order}",
            "templated": true
          },
          "effects": {
            "href": "https://horizon-testnet.paydex.org/ledgers/362987/effects{?cursor,limit,order}",
            "templated": true
          }
        },
      ...
      },
      {
        "_links": {
          "self": {
            "href": "https://horizon-testnet.paydex.org/ledgers/362986"
          },
          "transactions": {
            "href": "https://horizon-testnet.paydex.org/ledgers/362986/transactions{?cursor,limit,order}",
            "templated": true
          },
          "operations": {
            "href": "https://horizon-testnet.paydex.org/ledgers/362986/operations{?cursor,limit,order}",
            "templated": true
          },
          "payments": {
            "href": "https://horizon-testnet.paydex.org/ledgers/362986/payments{?cursor,limit,order}",
            "templated": true
          },
          "effects": {
            "href": "https://horizon-testnet.paydex.org/ledgers/362986/effects{?cursor,limit,order}",
            "templated": true
          }
        },
...
var emptyLedgersPage = `{
 "_links": {
    ...
    "next": {
      "href": "https://horizon-testnet.paydex.org/ledgers?cursor=1559004408971264&limit=2&order=desc"
    },
    "prev": {
      "href": "https://horizon-testnet.paydex.org/ledgers?cursor=1559008703938560&limit=2&order=asc"
    }
  },
  "_embedded": {
    "records": []
