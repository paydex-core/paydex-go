...
func (c *Client) setClientAppHeaders(req *http.Request) {
	req.Header.Set("X-Client-Name", "go-paydex-sdk")
...
// See https://www.paydex.org/developers/horizon/reference/endpoints/accounts-single.html
...
// See https://www.paydex.org/developers/horizon/reference/endpoints/data-for-account.html
...
// Effects returns effects(https://www.paydex.org/developers/horizon/reference/resources/effect.html)
...
// See https://www.paydex.org/developers/horizon/reference/endpoints/assets-all.html
...
// See https://www.paydex.org/developers/horizon/reference/endpoints/ledgers-all.html
...
// See https://www.paydex.org/developers/horizon/reference/endpoints/ledgers-single.html
...
// See https://www.paydex.org/developers/horizon/reference/endpoints/metrics.html
...
// See https://www.paydex.org/developers/horizon/reference/endpoints/fee-stats.html
...
// See https://www.paydex.org/developers/horizon/reference/endpoints/offers-for-account.html
func (c *Client) Offers(request OfferRequest) (offers hProtocol.OffersPage, err error) {
	err = c.sendRequest(request, &offers)
	return
}

// Operations returns paydex operations (https://www.paydex.org/developers/horizon/reference/resources/operation.html)
...
// OperationDetail returns a single paydex operations (https://www.pyadex.org/developers/horizon/reference/resources/operation.html)
...
// See https://www.paydex.org/developers/horizon/reference/endpoints/transactions-create.html
...
// Transactions returns paydex transactions (https://www.paydex.org/developers/horizon/reference/resources/transaction.html)
...
// See https://www.paydex.org/developers/horizon/reference/endpoints/transactions-single.html
...
// OrderBook returns the orderbook for an asset pair (https://www.paydex.org/developers/horizon/reference/resources/orderbook.html)
func (c *Client) OrderBook(request OrderBookRequest) (obs hProtocol.OrderBookSummary, err error) {
	err = c.sendRequest(request, &obs)
	return
}

// Paths returns the available paths to make a payment. See https://www.paydex.org/developers/horizon/reference/endpoints/path-finding.html
func (c *Client) Paths(request PathsRequest) (paths hProtocol.PathsPage, err error) {
	err = c.sendRequest(request, &paths)
	return
}

// Payments returns paydex account_merge, create_account, path payment and payment operations.
...
// Trades returns paydex trades (https://www.paydex.org/developers/horizon/reference/resources/trade.html)
...
// https://www.paydex.org/developers/guides/get-started/create-account.html for more information.
...
// TradeAggregations returns paydex trade aggregations (https://www.paydex.org/developers/horizon/reference/resources/trade_aggregation.html)
...
// StreamOperations streams paydex operations. It can be used to stream all operations or operations
...
// StreamPayments streams paydex payments. It can be used to stream all payments or payments
...
// StreamOffers streams offers processed by the Paydex network for an account. Use context.WithCancel
...
// StreamLedgers streams paydex ledgers. It can be used to stream all ledgers. Use context.WithCancel
// to stop streaming or context.Background() if you want to stream indefinitely.
