...
import (
	...
	"github.com/paydex-core/paydex-go/protocols/horizon/effects"
	"github.com/paydex-core/paydex-go/protocols/horizon/operations"
	"github.com/paydex-core/paydex-go/support/clock"
	"github.com/paydex-core/paydex-go/support/clock/clocktest"
...
func TestEffectsRequest(t *testing.T) {
	...
	if assert.NoError(t, err) {
		...
		links := effs.Links
		assert.Equal(t, links.Self.Href, "https://horizon-testnet.paydex.org/operations/43989725060534273/effects?cursor=&limit=10&order=asc")

		assert.Equal(t, links.Next.Href, "https://horizon-testnet.paydex.org/operations/43989725060534273/effects?cursor=43989725060534273-3&limit=10&order=asc")

		assert.Equal(t, links.Prev.Href, "https://horizon-testnet.paydex.org/operations/43989725060534273/effects?cursor=43989725060534273-1&limit=10&order=desc")
...
func TestOperationsRequest(t *testing.T) {
	...
	if assert.NoError(t, err) {
		...
		links := ops.Links
		assert.Equal(t, links.Self.Href, "https://horizon.paydex.org/transactions/b63307ef92bb253df13361a72095156d19fc0713798bc2e6c3bd9ee63cc3ca53/operations?cursor=&limit=10&order=asc")

		assert.Equal(t, links.Next.Href, "https://horizon.paydex.org/transactions/b63307ef92bb253df13361a72095156d19fc0713798bc2e6c3bd9ee63cc3ca53/operations?cursor=98447788659970049&limit=10&order=asc")

		assert.Equal(t, links.Prev.Href, "https://horizon.paydex.org/transactions/b63307ef92bb253df13361a72095156d19fc0713798bc2e6c3bd9ee63cc3ca53/operations?cursor=98447788659970049&limit=10&order=desc")
	...
	if assert.NoError(t, err) {
		assert.IsType(t, ops, operations.OperationsPage{})
		links := ops.Links
		assert.Equal(t, links.Self.Href, "https://horizon-testnet.paydex.org/payments?cursor=&limit=2&order=desc")

		assert.Equal(t, links.Next.Href, "https://horizon-testnet.paydex.org/payments?cursor=2024660468248577&limit=2&order=desc")

		assert.Equal(t, links.Prev.Href, "https://horizon-testnet.paydex.org/payments?cursor=2024660468256769&limit=2&order=asc")
	...
	if assert.NoError(t, err) {
		...
		assert.Equal(t, c.Links.Self.Href, "https://horizon-testnet.paydex.org/operations/1103965508866049")
		assert.Equal(t, c.Links.Effects.Href, "https://horizon-testnet.paydex.org/operations/1103965508866049/effects")
		assert.Equal(t, c.Links.Transaction.Href, "https://horizon-testnet.paydex.org/transactions/93c2755ec61c8b01ac11daa4d8d7a012f56be172bdfcaf77a6efd683319ca96d")

		assert.Equal(t, c.Links.Succeeds.Href, "https://horizon-testnet.paydex.org/effects?order=desc\u0026cursor=1103965508866049")

		assert.Equal(t, c.Links.Precedes.Href, "https://horizon-testnet.paydex.org/effects?order=asc\u0026cursor=1103965508866049")
	}
...
func TestSubmitRequest(t *testing.T) {
	...
	if assert.NoError(t, err) {
		...
		assert.Equal(t, resp.Links.Transaction.Href, "https://horizon-testnet.paydex.org/transactions/bcc7a97264dca0a51a63f7ea971b5e7458e334489673078bb2a34eb0cce910ca")
...
func TestTransactionsRequest(t *testing.T) {
	...
	if assert.NoError(t, err) {
		...
		links := txs.Links
		assert.Equal(t, links.Self.Href, "https://horizon-testnet.payde.org/transactions?cursor=&limit=10&order=desc")

		assert.Equal(t, links.Next.Href, "https://horizon-testnet.paydex.org/transactions?cursor=1881762611335168&limit=10&order=desc")

		assert.Equal(t, links.Prev.Href, "https://horizon-testnet.paydex.org/transactions?cursor=1881771201286144&limit=10&order=asc")
...
var accountResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex.org/accounts/GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU"
    },
    "transactions": {
      "href": "https://horizon-testnet.paydex.org/accounts/GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU/transactions{?cursor,limit,order}",
      "templated": true
    },
    "operations": {
      "href": "https://horizon-testnet.paydex.org/accounts/GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU/operations{?cursor,limit,order}",
      "templated": true
    },
    "payments": {
      "href": "https://horizon-testnet.paydex.org/accounts/GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU/payments{?cursor,limit,order}",
      "templated": true
    },
    "effects": {
      "href": "https://horizon-testnet.paydex.org/accounts/GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU/effects{?cursor,limit,order}",
      "templated": true
    },
    "offers": {
      "href": "https://horizon-testnet.paydex.org/accounts/GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU/offers{?cursor,limit,order}",
      "templated": true
    },
    "trades": {
      "href": "https://horizon-testnet.paydex.org/accounts/GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU/trades{?cursor,limit,order}",
      "templated": true
    },
    "data": {
      "href": "https://horizon-testnet.paydex.org/accounts/GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU/data/{key}",
      "templated": true
    }
  },
...
var notFoundResponse = `{
  "type": "https://paydex.org/horizon-errors/not_found",
...
var effectsResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex.org/operations/43989725060534273/effects?cursor=&limit=10&order=asc"
    },
    "next": {
      "href": "https://horizon-testnet.paydex.org/operations/43989725060534273/effects?cursor=43989725060534273-3&limit=10&order=asc"
    },
    "prev": {
      "href": "https://horizon-testnet.paydex.org/operations/43989725060534273/effects?cursor=43989725060534273-1&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          "operation": {
            "href": "https://horizon-testnet.paydex.org/operations/43989725060534273"
          },
          "succeeds": {
            "href": "https://horizon-testnet.paydex.org/effects?order=desc&cursor=43989725060534273-1"
          },
          "precedes": {
            "href": "https://horizon-testnet.paydex.org/effects?order=asc&cursor=43989725060534273-1"
          }
        },
      ...
      },
      {
        "_links": {
          ...
          "succeeds": {
            "href": "https://horizon-testnet.paydex.org/effects?order=desc&cursor=43989725060534273-2"
          },
          "precedes": {
            "href": "https://horizon-testnet.paydex.org/effects?order=asc&cursor=43989725060534273-2"
          }
        },
      ...
      },
      {
        "_links": {
          ...
          "succeeds": {
            "href": "https://horizon-testnet.paydex.org/effects?order=desc&cursor=43989725060534273-3"
          },
          "precedes": {
            "href": "https://horizon-testnet.paydex.org/effects?order=asc&cursor=43989725060534273-3"
          }
        },
...
var assetsResponse = `{
    "_links": {
        "self": {
            "href": "https://horizon-testnet.paydex.org/assets?cursor=&limit=1&order=desc"
        },
        "next": {
            "href": "https://horizon-testnet.paydex.org/assets?cursor=ABC_GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU_credit_alphanum12&limit=1&order=desc"
        },
        "prev": {
            "href": "https://horizon-testnet.paydex.org/assets?cursor=ABC_GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU_credit_alphanum12&limit=1&order=asc"
        }
    },
    "_embedded": {
        "records": [
...
var ledgerResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex.org/ledgers/69859"
    },
    "transactions": {
      "href": "https://horizon-testnet.paydex.org/ledgers/69859/transactions{?cursor,limit,order}",
      "templated": true
    },
    "operations": {
      "href": "https://horizon-testnet.paydex.org/ledgers/69859/operations{?cursor,limit,order}",
      "templated": true
    },
    "payments": {
      "href": "https://horizon-testnet.paydex.org/ledgers/69859/payments{?cursor,limit,order}",
      "templated": true
    },
    "effects": {
      "href": "https://horizon-testnet.paydex.org/ledgers/69859/effects{?cursor,limit,order}",
      "templated": true
    }
  },
...
var metricsResponse = `{
  ...
  "paydex_core.latest_ledger": {
    "value": 22826156
  },
  "paydex_core.open_connections": {
    "value": 94
  },
  "txsub.buffered": {
    "value": 1
...
var offersResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex.org/accounts/GDOJCPYIB66RY4XNDLRRHQQXB27YLNNAGAYV5HMHEYNYY4KUNV5FDV2F/offers?cursor=&limit=10&order=asc"
    },
    "next": {
      "href": "https://horizon-testnet.paydex.org/accounts/GDOJCPYIB66RY4XNDLRRHQQXB27YLNNAGAYV5HMHEYNYY4KUNV5FDV2F/offers?cursor=432323&limit=10&order=asc"
    },
    "prev": {
      "href": "https://horizon-testnet.paydex.org/accounts/GDOJCPYIB66RY4XNDLRRHQQXB27YLNNAGAYV5HMHEYNYY4KUNV5FDV2F/offers?cursor=432323&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          "self": {
            "href": "https://horizon-testnet.paydex.org/offers/432323"
          },
          "offer_maker": {
            "href": "https://horizon-testnet.paydex.org/accounts/GDOJCPYIB66RY4XNDLRRHQQXB27YLNNAGAYV5HMHEYNYY4KUNV5FDV2F"
          }
        },
        "id": 432323,
        "paging_token": "432323",
...
var multipleOpsResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon.paydex.org/transactions/b63307ef92bb253df13361a72095156d19fc0713798bc2e6c3bd9ee63cc3ca53/operations?cursor=&limit=10&order=asc"
    },
    "next": {
      "href": "https://horizon.paydex.org/transactions/b63307ef92bb253df13361a72095156d19fc0713798bc2e6c3bd9ee63cc3ca53/operations?cursor=98447788659970049&limit=10&order=asc"
    },
    "prev": {
      "href": "https://horizon.paydex.org/transactions/b63307ef92bb253df13361a72095156d19fc0713798bc2e6c3bd9ee63cc3ca53/operations?cursor=98447788659970049&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          "self": {
            "href": "https://horizon.paydex.org/operations/98447788659970049"
          },
          "transaction": {
            "href": "https://horizon.paydex.org/transactions/b63307ef92bb253df13361a72095156d19fc0713798bc2e6c3bd9ee63cc3ca53"
          },
          "effects": {
            "href": "https://horizon.paydex.org/operations/98447788659970049/effects"
          },
          "succeeds": {
            "href": "https://horizon.paydex.org/effects?order=desc&cursor=98447788659970049"
          },
          "precedes": {
            "href": "https://horizon.paydex.org/effects?order=asc&cursor=98447788659970049"
          }
        },
      ...
      },
      {
        "_links": {
          "self": {
            "href": "https://horizon.paydex.org/operations/98448467264811009"
          },
          "transaction": {
            "href": "https://horizon.paydex.org/transactions/af68055329e570bf461f384e2cd40db023be32f1c38a756ba2db08b6baf66148"
          },
          "effects": {
            "href": "https://horizon.paydex.org/operations/98448467264811009/effects"
          },
          "succeeds": {
            "href": "https://horizon.paydex.org/effects?order=desc&cursor=98448467264811009"
          },
          "precedes": {
            "href": "https://horizon.paydex.org/effects?order=asc&cursor=98448467264811009"
          }
        },
      ...
      },  
      {
        "_links": {
          "self": {
            "href": "http://horizon-mon.paydex-ops.com/operations/98455906148208641"
          },
          "transaction": {
            "href": "http://horizon-mon.paydex-ops.com/transactions/ade3c60f1b581e8744596673d95bffbdb8f68f199e0e2f7d63b7c3af9fd8d868"
          },
          "effects": {
            "href": "http://horizon-mon.paydex-ops.com/operations/98455906148208641/effects"
          },
          "succeeds": {
            "href": "http://horizon-mon.paydex-ops.com/effects?order=desc\u0026cursor=98455906148208641"
          },
          "precedes": {
            "href": "http://horizon-mon.paydex-ops.com/effects?order=asc\u0026cursor=98455906148208641"
          }
        },
...
var opsResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex.org/operations/1103965508866049"
    },
    "transaction": {
      "href": "https://horizon-testnet.paydex.org/transactions/93c2755ec61c8b01ac11daa4d8d7a012f56be172bdfcaf77a6efd683319ca96d"
    },
    "effects": {
      "href": "https://horizon-testnet.paydex.org/operations/1103965508866049/effects"
    },
    "succeeds": {
      "href": "https://horizon-testnet.paydex.org/effects?order=desc\u0026cursor=1103965508866049"
    },
    "precedes": {
      "href": "https://horizon-testnet.paydex.org/effects?order=asc\u0026cursor=1103965508866049"
    }
  },
  "id": "1103965508866049",
...
var txSuccess = `{
    "_links": {
        "transaction": {
            "href": "https://horizon-testnet.paydex.org/transactions/bcc7a97264dca0a51a63f7ea971b5e7458e334489673078bb2a34eb0cce910ca"
        }
    },
...
var transactionFailure = `{
  "type": "https://paydex.org/horizon-errors/transaction_failed",
  "title": "Transaction Failed",
  "status": 400,
  "detail": "The transaction failed when submitted to the paydex network. The extras.result_codes field on this response contains further details.  Descriptions of each code can be found at: https://www.paydex.org/developers/learn/concepts/list-of-operations.html",
  "instance": "horizon-testnet-001.prd.paydex001.internal.paydex-ops.com/4elYz2fHhC-528285",
  "extras": {
...
var txPageResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex.org/transactions?cursor=&limit=10&order=desc"
    },
    "next": {
      "href": "https://horizon-testnet.paydex.org/transactions?cursor=1881762611335168&limit=10&order=desc"
    },
    "prev": {
      "href": "https://horizon-testnet.paydex.org/transactions?cursor=1881771201286144&limit=10&order=asc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          "self": {
            "href": "https://horizon-testnet.paydex.org/transactions/3274f131af56ecb6d8668acf6eb0b31b5f8faeca785cbce0a911a5a81308a599"
          },
          "account": {
            "href": "https://horizon-testnet.paydex.org/accounts/GAIH3ULLFQ4DGSECF2AR555KZ4KNDGEKN4AFI4SU2M7B43MGK3QJZNSR"
          },
          "ledger": {
            "href": "https://horizon-testnet.paydex.org/ledgers/438134"
          },
          "operations": {
            "href": "https://horizon-testnet.paydex.org/transactions/3274f131af56ecb6d8668acf6eb0b31b5f8faeca785cbce0a911a5a81308a599/operations{?cursor,limit,order}",
            "templated": true
          },
          "effects": {
            "href": "https://horizon-testnet.paydex.org/transactions/3274f131af56ecb6d8668acf6eb0b31b5f8faeca785cbce0a911a5a81308a599/effects{?cursor,limit,order}",
            "templated": true
          },
          "precedes": {
            "href": "https://horizon-testnet.paydex.org/transactions?order=asc&cursor=1881771201286144"
          },
          "succeeds": {
            "href": "https://horizon-testnet.paydex.org/transactions?order=desc&cursor=1881771201286144"
          }
        },
      ...
      },
      {
        ...
        "_links": {
          "self": {
            "href": "https://horizon-testnet.paydex.org/transactions/5131aed266a639a6eb4802a92fba310454e711ded830ed899745b9e777d7110c"
          },
          "account": {
            "href": "https://horizon-testnet.paydex.org/accounts/GC3IMK2BSHNZZ4WAC3AXQYA7HQTZKUUDJ7UYSA2HTNCIX5S5A5NVD3FD"
          },
          "ledger": {
            "href": "https://horizon-testnet.paydex.org/ledgers/438134"
          },
          "operations": {
            "href": "https://horizon-testnet.paydex.org/transactions/5131aed266a639a6eb4802a92fba310454e711ded830ed899745b9e777d7110c/operations{?cursor,limit,order}",
            "templated": true
          },
          "effects": {
            "href": "https://horizon-testnet.paydex.org/transactions/5131aed266a639a6eb4802a92fba310454e711ded830ed899745b9e777d7110c/effects{?cursor,limit,order}",
            "templated": true
          },
          "precedes": {
            "href": "https://horizon-testnet.paydex.org/transactions?order=asc&cursor=1881771201282048"
          },
          "succeeds": {
            "href": "https://horizon-testnet.paydex.org/transactions?order=desc&cursor=1881771201282048"
          }
        },
...
var orderBookNotFound = `{
  "type": "https://paydex.org/horizon-errors/invalid_order_book",
...
var paymentsResponse = `{
  "_links": {
    "self": {
      "href": "https://horizon-testnet.paydex.org/payments?cursor=&limit=2&order=desc"
    },
    "next": {
      "href": "https://horizon-testnet.paydex.org/payments?cursor=2024660468248577&limit=2&order=desc"
    },
    "prev": {
      "href": "https://horizon-testnet.paydex.org/payments?cursor=2024660468256769&limit=2&order=asc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          "self": {
            "href": "https://horizon-testnet.paydex.org/operations/2024660468256769"
          },
          "transaction": {
            "href": "https://horizon-testnet.paydex.org/transactions/a0207513c372146bae8cdb299975047216cb1ffb393074b2015b39496e8767c2"
          },
          "effects": {
            "href": "https://horizon-testnet.paydex.org/operations/2024660468256769/effects"
          },
          "succeeds": {
            "href": "https://horizon-testnet.paydex.org/effects?order=desc&cursor=2024660468256769"
          },
          "precedes": {
            "href": "https://horizon-testnet.paydex.org/effects?order=asc&cursor=2024660468256769"
          }
        },
        "id": "2024660468256769",
      ...
      },
      {
        "_links": {
          "self": {
            "href": "https://horizon-testnet.paydex.org/operations/2024660468248577"
          },
          "transaction": {
            "href": "https://horizon-testnet.paydex.org/transactions/87d7a29539e7902b14a6c720094856f74a77128ab332d8629432c5a176a9fe7b"
          },
          "effects": {
            "href": "https://horizon-testnet.paydex.org/operations/2024660468248577/effects"
          },
          "succeeds": {
            "href": "https://horizon-testnet.paydex.org/effects?order=desc&cursor=2024660468248577"
          },
          "precedes": {
            "href": "https://horizon-testnet.paydex.org/effects?order=asc&cursor=2024660468248577"
          }
        },
        "id": "2024660468248577",
