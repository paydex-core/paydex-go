...
This library provides an interface to the Paydex Horizon service. It supports the building of Go applications on
top of the Paydex network (https://www.paydex.org/). Transactions may be constructed using the sister package to
this one, txnbuild (https://github.com/paydex-core/paydex-go/tree/master/txnbuild), and then submitted with this client to any
Horizon instance for processing onto the ledger. Together, these two libraries provide a complete Paydex SDK.
...
const (
	...
	// AssetTypeNative represents the asset type for Paydex Lumens (XLM)
...
// Client struct contains data for creating a horizon client that connects to the paydex network.
type Client struct {
...
var DefaultTestNetClient = &Client{
	HorizonURL:     "https://horizon-testnet.paydex.org/",
...
var DefaultPublicNetClient = &Client{
	HorizonURL:     "https://horizon.paydex.org/",
	HTTP:           http.DefaultClient,
	horizonTimeOut: HorizonTimeOut,
}
