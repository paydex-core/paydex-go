...
This is a small tool, written in Go, for working with `paydex-core` history archives directly.
It is a standalone tool that does not require `paydex-core`, or any other programs.

It is much smaller and simpler than `paydex-core`, and is intended only for archive-maintenance tasks.
...
```
$ go install github.com/paydex-core/paydex-go/tools/paydex-archivist
```

## Usage

```
inspect paydex history archive

Usage:
  paydex-archivist [flags]
  paydex-archivist [command]
...
Flags:
  ...
  -h, --help              help for paydex-archivist
...
Use "paydex-archivist [command] --help" for more information about a command.
```

## Specifying history archives

Unlike `paydex-core`, `paydex-archivist` does not run subprocesses to access history archives;
...
`paydex-archivist` supports reading from and writing to any S3-compatible storage.
...
```
$ paydex-archivist status --s3endpoint ams3.digitaloceanspaces.com s3://bucketname/prefix
```
...
$ paydex-archivist status --s3endpoint https://storage.googleapis.com s3://google-storage-bucketname
``` 
...
```
$ paydex-archivist status http://s3-eu-west-1.amazonaws.com/history.paydex.org/prd/core-testnet/core_testnet_001

       Archive: http://s3-eu-west-1.amazonaws.com/history.paydex.org/prd/core-testnet/core_testnet_001
...
```
$ paydex-archivist mirror http://s3-eu-west-1.amazonaws.com/history.paydex.org/prd/core-testnet/core_testnet_001 file://local-archive

2016/02/10 18:27:09 mirroring http://s3-eu-west-1.amazonaws.com/history.paydex.org/prd/core-testnet/core_testnet_001 -> file://local-archive
...
```
$ paydex-archivist mirror --recent http://history.paydex.org/prd/core-live/core_live_001 file://local-archive

2019/08/21 13:53:15 mirroring http://history.paydex.org/prd/core-live/core_live_001 -> file://local-archive
...
```
$ paydex-archivist --last 1024 mirror http://history.paydex.org/prd/core-testnet/core_testnet_001 file://local-archive

2016/02/10 19:14:01 mirroring http://s3-eu-west-1.amazonaws.com/history.paydex.org/prd/core-testnet/core_testnet_001 -> file://local-archive
...
```
$ paydex-archivist scan file://local-archive
...
```
$ paydex-archivist --last 4096 scan file://local-archive
...
$ paydex-archivist --low 1000000 --high 1006000 scan file://local-archive
...
```
$ paydex-archivist --verify --last 4096 scan file://local-archive
...
$ paydex-archivist repair file://local-archive file://broken-archive
...
```
 paydex-archivist dumpxdr local-archive/transactions//00/20/de/transactions-0020de7f.xdr.gz
