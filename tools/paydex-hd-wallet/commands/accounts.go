...
import (
	...
	"github.com/paydex-core/paydex-go/exp/crypto/derivation"
...
var AccountsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		masterKey, err := derivation.DeriveForPath(derivation.PaydexAccountPrefix, seed)
		if err != nil {
		...
		for i := uint32(startID); i < startID+count; i++ {
			...
			println(fmt.Sprintf(derivation.PaydexAccountPathFormat, i), kp.Address(), kp.Seed())
		}
